defmodule Excommerce.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Excommerce.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> Excommerce.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> Excommerce.ShoppingCart.create_cart_item()
