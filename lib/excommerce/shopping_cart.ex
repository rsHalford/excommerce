defmodule Excommerce.ShoppingCart do
  @moduledoc """
  ...
  alias Excommerce.Cart
  alias Excommerce.ShoppingCart.{Cart, CartItem}
  ...
  @doc """
  Adds the provided product item to the cart.
  """
  ...
  @doc """
  Remover a product item from the user's cart.
  """
...
alias Excommerce.ShoppingCart.CartItem
